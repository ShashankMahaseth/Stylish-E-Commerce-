...
android {
    ...
    defaultConfig {
        ...
        // Load Razorpay key from local properties
        val razorpayPropsFile = rootProject.file("razorpay.properties")
        if (razorpayPropsFile.exists()) {
            val props = Properties().apply {
                load(razorpayPropsFile)
            }
            buildConfigField("String", "RAZORPAY_KEY", "\"${props["RAZORPAY_KEY"]}\"")
        }

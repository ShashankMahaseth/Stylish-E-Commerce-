...
@Composable
fun PaymentDetails(upiId: String, onUpiIdChanged: (String) -> Unit) {
    ...
    Row(modifier = Modifier
        ...
        Column {
            ...
            Text(text = "Upi Id", color = colorResource(R.color.Silver))
            SettingTextField(value = upiId, onUpiIdChanged, enable)
